...
spark_queries.py
================
Spark-based implementation of Query 2 (Q2)
Compares Spark DataFrame vs SQLite for Query 2.

Command:
    python spark_queries.py

Output:
    Prints Q2 results and timing for both SQLite and Spark
"""
...
# =============================================================================
# PART 1 — SQLite Q2 (for comparison baseline)
# =============================================================================
