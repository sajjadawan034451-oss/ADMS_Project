...
generate_data.py
================
Generates synthetic data for the ADM mobility platform project.
No external dependencies — uses only Python standard library.

Entities:
  Users    – name, surname, birthdate, country
  Stations – name, city, max_capacity
  Trips    – user, start/end station, times, cost
